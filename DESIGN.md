...
- **Current save version: 30.** v0.45 requires **31** (see table).
...
`SAVE_VERSION`: 27→28 (v0.40), stays on 28 (v0.41–v0.43), reaches 30 across two bumps (v0.44), no bump (v0.44.1–v0.44.4), 30→31 (v0.45), no bump (v0.45.1–v0.45.3).
